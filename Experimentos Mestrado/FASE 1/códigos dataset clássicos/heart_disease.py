# -*- coding: utf-8 -*-
"""
Created on Fri Dec 22 01:10:47 2023
...
# Carregar o conjunto de dados Heart Disease usando fetch_ucirepo
...
y_train = tf.one_hot(y_train, depth=len(set(y)))  # Número de classes no conjunto de dados Heart Disease
...
def get_loss(X, y):
    def _loss(w, b):
        with tf.GradientTape() as tape:
            ...
            # Remove a última dimensão de pred
...
# Parâmetros
layers = [X_train.shape[1]] + 1*[20] + [len(set(y))]  # Ajustar a entrada e a saída para o conjunto de dados Heart Disease
pop_size = 25
n_iter = 1000
sample_size = 512
noise = 0.0
...
opt = pso(
    ...
    8e-1,
    5e-1,
    initialization_method=None, #"xavier",
    verbose=True,
    gd_alpha=0.01,
)
