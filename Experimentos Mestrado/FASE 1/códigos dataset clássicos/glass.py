# -*- coding: utf-8 -*-
"""
Created on Thu Jan  4 03:18:27 2024
...
glass_data = pd.read_csv('glass.csv', header=None)  # Indicando que o conjunto de dados não possui cabeçalho

# Separar características (X) e rótulos (y)
X = glass_data.drop(9, axis=1).values  
y = glass_data[9].values
...
# Parâmetros
num_classes = len(set(y))  # Número de classes no conjunto de dados Glass Identification
layers = [X_train.shape[1]] + 1*[20] + [num_classes]
pop_size = 25
n_iter = 1000
sample_size = 512
noise = 0.0
