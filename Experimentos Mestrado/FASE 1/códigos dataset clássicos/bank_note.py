# -*- coding: utf-8 -*-
"""
Created on Fri Dec 22 01:15:59 2023
...
# Carregar o conjunto de dados Banknote Authentication
#file_path = 'C:/Users\MICRO\Desktop\Disserat\00 basico\00 implementation\Exp_classifications/banknote_authentication.csv'  # Substituir pelo caminho real do seu arquivo
banknote_data = pd.read_csv('banknote-authentication.csv')
...
y_train = tf.one_hot(y_train, depth=len(set(y)))  # Número de classes no conjunto de dados Banknote Authentication
...
# Parâmetros
layers = [X_train.shape[1]] + 1*[20] + [len(set(y))]  # Ajustar a entrada e a saída para o conjunto de dados Banknote Authentication
pop_size = 25
n_iter = 1000
sample_size = 512
noise = 0.0
